        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
            ...
            <div>
                ...
                <p className='text-gray-600 mb-4'>
                    ...
                    Whether you need stunning visuals or unique imagery, our tool transforms your
                    text intp eye-catching images with just a few clicks. Imagine it, describe it,
                ...
                <p className='text-gray-600'>
                   ...
                   product visuals to character desgns and portraits, 
